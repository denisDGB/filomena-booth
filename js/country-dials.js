window.COUNTRY_DIALS = [
  ...
  { iso: "IM", name: "Isla de Man", dial: "44" },
  { iso: "NF", name: "Isla Norfolk", dial: "672" },
  { iso: "IS", name: "Islandia", dial: "354" },
  { iso: "KY", name: "Islas Caimán", dial: "1" },
  { iso: "CK", name: "Islas Cook", dial: "682" },
  { iso: "FO", name: "Islas Feroe", dial: "298" },
  { iso: "FK", name: "Islas Malvinas", dial: "500" },
  { iso: "MP", name: "Islas Marianas del Norte", dial: "1" },
  { iso: "MH", name: "Islas Marshall", dial: "692" },
  { iso: "SB", name: "Islas Salomón", dial: "677" },
  { iso: "TC", name: "Islas Turcas y Caicos", dial: "1" },
  { iso: "VG", name: "Islas Vírgenes Británicas", dial: "1" },
  { iso: "VI", name: "Islas Vírgenes de EE. UU.", dial: "1" },
  ...
  { iso: "AS", name: "Samoa Americana", dial: "1" },
  { iso: "BL", name: "San Bartolomé", dial: "590" },
  { iso: "KN", name: "San Cristóbal y Nieves", dial: "1" },
  { iso: "SM", name: "San Marino", dial: "378" },
  { iso: "MF", name: "San Martín", dial: "590" },
  { iso: "PM", name: "San Pedro y Miquelón", dial: "508" },
  { iso: "VC", name: "San Vicente y las Granadinas", dial: "1" },
  { iso: "SH", name: "Santa Elena", dial: "290" },
  { iso: "LC", name: "Santa Lucía", dial: "1" },
  ...
  { iso: "VA", name: "Vaticano", dial: "39" },
  { iso: "VE", name: "Venezuela", dial: "58" },
  { iso: "VN", name: "Vietnam", dial: "84" },
  { iso: "WF", name: "Wallis y Futuna", dial: "681" },
